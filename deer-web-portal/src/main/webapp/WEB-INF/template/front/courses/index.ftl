...
<!--主修课majorsubject-->
<div class="section" style="height:550px;background-color:#f2f2f2;text-align:center">
    <div class="container p-y-xl b-b">
        ...
        <img src="${base}/resources/front/img/majorsubject.png" class="img-rounded" style="width:80%; height:100%">
    </div><!-- .container -->
</div><!-- .section -->
<!--主修课-->
...
<div id="begin-unit" style="height:700px;background-color:#f2f2f2;text-align:center;padding:50px;">
    <img src="${base}/resources/front/img/bottompic.png" class="img-rounded" style="width:80%; height:100%">
</div>
<!--底部大图bottompic-->
